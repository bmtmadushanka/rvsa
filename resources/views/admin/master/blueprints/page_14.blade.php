<div class="page-content">
    <table class="table table-bordered w-100 table-fixed">
        <thead>
        <tr>
            <td colspan="4" class="text-center fw-bold pt-2 pb-3 fs-14">Under Body Front End Measurements</td>
        </tr>
        </thead>
        <tbody class="image" data-id="14.1">
        <tr>
            @for($i = 1; $i <= 4; $i++)
        ...
        <tr>
            @for($i = 1; $i <= 4; $i++)
                <td class="border-top-0 align-top p-2 text-center">
                    <span class="placeholder-empty">Description</span>
                </td>
            @endfor
        </tr>
        </tbody>
