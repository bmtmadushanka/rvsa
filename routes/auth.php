...
Route::get('/password-reset', [PasswordResetLinkController::class, 'verify'])
                ->middleware('guest')
...
Route::get('/verify-mobile', [VerifyMobileController::class, 'prompt'])
                ->middleware('auth')
                ->name('verify_mobile.prompt');

Route::post('/verify-mobile', [VerifyMobileController::class, 'verify'])
                ->middleware('auth')
                ->name('verify_mobile.verify');
